...
# Main function 
def DecodeAndVis(imagegraph, filename, imagesize=256, max_degree=6, thr=0.5, edge_thr = 0.5, snap=True, kp_limit = 500, drop=False, use_graph_refine=False, testing=False, spacenet = False, angledistance_weight = 100, snap_dist = 300):
